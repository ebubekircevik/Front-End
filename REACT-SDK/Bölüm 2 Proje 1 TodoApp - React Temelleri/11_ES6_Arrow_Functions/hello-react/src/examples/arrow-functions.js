...
let helloES6 = () => console.log('hello from es6'); //birden fazla kod satırı olacaksa suslu parantez kullanılmalı {}
...
let getProductES6 = (id,name) => ({ // geriye object dondurur. burada dikkat edilmesi gereken obje parantezlerinin dışına normal parantez eklendi. kullanım bu şekilde
    id: id, 
    name: name
});
