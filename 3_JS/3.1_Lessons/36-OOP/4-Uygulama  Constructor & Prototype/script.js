...
function Employee(name,salary){
    ...
    if (!(this instanceof Employee)){ // bu constructor dan turetilen nesne fonksiyon şeklinde uretildeyse[Employee("Ahmet",300) gibi..] geriye sınıf dondur. Uretilirken hata yapılmaması için yazıldı
